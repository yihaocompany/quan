			...
			if (Object.prototype.toString.call(arg.preview) === "[object Array]") {
				...
				if (leng > 0) {
					...
					for (var i = 0; i < leng; i++) {
						...
						HTML += '<a href="javascript:;" style="width:' + arg.preview[i] + "px;height:" + (p ? Math.round(arg.preview[i] / p) + "px;" : "auto;") + "margin-right:" + margin_right + "px;background-color: #F5F5F5;border: " + borderW + "px solid #F5F5F5;" + '"><images src="' + srcDefault + '"/></a>';
					}
