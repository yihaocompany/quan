            ...
            function d(e, t) {
                ...
                A.append(d),
                    a.forEach(function(e) {
                        ...
                        t && (c.append(t), d.append(c), c.on("click",
                            function(e) {
                                l(r),
            ...
            function R(e) {
                ...
                return (e.childNodes() || []).forEach(function(e) {
                    ...
                    if (3 === i && (n = e.textContent, n = a(n)), 1 === i) {
                        ...
                        for (var A = [], r = e.attributes || {},
                                 c = r.length || 0, s = 0; s < c; s++) {
                            var l = r[s];
                            A.push({
                                name: l.name,
                                value: l.value
            ...
            q.bold = l,
                ...
                U.prototype = {
                        ...
                        c.on("paste",
                            function(i) {
                                if (!J.isIE() && (i.preventDefault(), e())) {
                                    ...
                                    if (l) {
                                        var d = l.getNodeName();
                                        if ("CODE" === d || "PRE" === d) return A && s(A) && (a = "" + (A(a) || "")),
                    ...
                    _dragHandle: function() {
                        var e = this.editor;
                        o(document).on("dragleave drop dragenter dragover",
                            function(e) {
                                e.preventDefault()
                            }),
                            e.$textElem.on("drop",
                            ...
                            if (r(v,
                                ...
                                C.upload && (C.upload.onprogress = function(e) {
                                    ...
                                    if (4 === C.readyState) {
                                        ...
                                        } else f.fail && "function" == typeof f.fail && f.fail(C, n, e),
            ...
            j.prototype = {
                ...
                _initDom: function() {
                    var e = this,
                        ...
                        l = void 0,
                        d = void 0;
                    null == i ? (a = o("<div></div>"), s = o("<div></div>"), d = n.children(), n.append(a).append(s), a.css("background-color", "#f1f1f1").css("border", "1px solid #ccc"), s.css("border", "1px solid #ccc").css("border-top", "none").css("height", "300px")) : (a = n, s = o(i), d = s.children()),
                        l = o("<div></div>"),
                    ...
                    (A.onfocus || A.onblur) && (this.isFocus = !1, o(document).on("click",
                        function(t) {
                            var n = l.isContain(o(t.target)),
                                i = a.isContain(o(t.target)),
                                A = a[0] == t.target;
                            if (n) e.isFocus || e.onfocus && e.onfocus(),
                                e.isFocus = !0;
                            else {
                                if (i && !A) return;
                ...
                _bindEvent: function() {
                    var e = 0,
                        t = this.txt.html(),
                        n = this.config,
                        i = n.onchangeTimeout; (!(i = parseInt(i, 10)) || i <= 0) && (i = 200);
                    var o = n.onchange;
