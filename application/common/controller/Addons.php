...
class Addons extends Base {
	...
	public function _initialize() {
		...
		$this->addon_path = YIHAO_ADDON_PATH . "{$mc}/";
	...
	public function template() {
		...
		$parse_str['__ADDONROOT__'] = YIHAO_ADDON_PATH . "{$mc}";
		\think\Config::set('parse_str', $parse_str);

		$this->view->engine(
			array(
				'view_path' => YIHAO_ADDON_PATH . $mc . "/view/",
				'replace'   => array('__ADDONROOT__'=>YIHAO_ADDON_PATH . "{$mc}")
			)
		);
	}
